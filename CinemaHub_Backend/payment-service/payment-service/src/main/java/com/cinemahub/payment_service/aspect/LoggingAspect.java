package com.cinemahub.payment_service.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.cinemahub.payment_service.controller..*(..))")
    ...
    @Around("execution(* com.cinemahub.payment_service.service..*(..))")
